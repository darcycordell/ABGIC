...
zn(7).thick = [50 1400 11600 16000 9000 62000 150000 160000 110000 150000 230000 100000];
zn(7).rho = [30 10 3000 1750 1200 1400 635 50 20 5.62 1.58 1.12];

%Unnamed Zone
zn(15).thick = zn(7).thick; %Zone #2 (zn(2)) has no resistivity model associated with it but it is              
zn(15).rho = zn(7).rho;     %given the same values as Zone #1 here

%Zone #6
zn(6).thick = [65 2700 9000 17000 10000 61000 150000 160000 110000 150000 230000 100000];
zn(6).rho = [50 15 3000 2300 2100 1400 160 50 20 5.6 1.58 1.12];

%Zone #5
zn(5).thick = [35 3100 16000 10000 10000 61000 150000 160000 110000 150000 230000 100000];
zn(5).rho = [30 20 440 900 330 950 160 40 20 5.6 1.58 0.89];

%Zone #10
zn(10).thick = [175 1900 6000 10000 22000 60000 150000 160000 110000 150000 230000 100000];
zn(10).rho = [30 10 1000 1300 800 500 625 50 20 5.62 1.58 1.12];

%Zone #8
zn(8).thick = [25 3300 11700 15000 9000 61000 150000 160000 110000 150000 230000 100000];
zn(8).rho = [30 10 900 275 360 315 660 50 20 5.62 1.58 1.12];

%Zone #3
zn(3).thick = [40 2900 16000 10000 12000 59000 150000 160000 110000 150000 230000 100000];
zn(3).rho = [30 6 2000 3000 620 150 230 90 8 2.4 0.89 0.47];

%Zone #1
zn(1).thick = [75 2200 13000 12500 17500 55000 150000 160000 110000 150000 230000 100000];
zn(1).rho = [30 30 385 2500 2500 2250 550 40 8 2.4 0.89 0.47];
...
%Zone #2
zn(2).thick = [50 2400 21600 13000 8000 55000 150000 160000 110000 150000 230000 100000];
zn(2).rho = [30 25 3000 2000 4000 2000 260 70 8 2.4 0.89 0.47];

%Zone #4
zn(4).thick = [50 2000 17000 10000 14000 57000 150000 160000 110000 150000 230000 100000];
zn(4).rho = [50 10 1900 1700 850 500 530 90 8 2.4 0.89 0.47];
...
% Zone #1
zn(16).thick = [25 1000 8500 10500 10000 70000 50000 100000 160000 110000 150000 230000 100000];
zn(16).rho = [30 25 610 310 90 200 230 200 40 11 2 1.22 0.77];

% Zone 2N
zn(17).thick = [2 12500 15500 3500 68500 150000 160000 110000 150000 230000 100000];
zn(17).rho = [115 43000 34800 26000 25800 2300 100 20 5.62 1.58 0.89];

% Zone 3B
zn(18).thick = [50 2500 8500 12000 9000 68000 50000 100000 160000 110000 150000 230000 100000];
zn(18).rho = [75 50 600 550 415 210 95 380 80 25 5.62 1.58 0.89];

% Zone 5N
zn(19).thick = [10 11500 16000 11500 61000 150000 160000 110000 150000 230000 100000];
zn(19).rho = [70 43800 24900 46200 1750 1950 120 20 5.62 1.58 0.89];

%Zone 4S
zn(12).thick = [2 14500 9500 13000 63000 50000 100000 160000 110000 150000 230000 100000];
zn(12).rho = [70 740 300 65 130 265 210 50 20 5.62 1.58 0.89];

% Zone 3N
zn(20).thick = [10 13000 20000 3500 63500 150000 160000 110000 150000 230000 100000];
zn(20).rho = [70 27700 30900 21000 15600 3200 100 20 5.62 1.58 0.89];

% Zone 1
zn(21).thick = [25 1000 8500 10500 10000 70000 50000 100000 160000 110000 150000 230000 100000];
zn(21).rho = [30 25 610 310 90 200 230 200 40 11 2 1.22 0.77];

% Zone 2S
zn(22).thick = [2 11000 12000 11500 65500 50000 100000 160000 110000 150000 230000 100000];
zn(22).rho = [115 820 810 260 120 120 210 50 20 5.62 1.58 0.89];

% Zone 4N
zn(23).thick = [15 16500 12000 9000 62500 150000 160000 110000 150000 230000 100000];
zn(23).rho = [70 27800 1400 20 16350 1850 100 20 5.62 1.58 0.89];

%Zone 5S
zn(13).thick = [2 13000 7500 21500 58000 50000 100000 160000 110000 150000 230000 100000];
zn(13).rho = [70 520 500 250 370 750 210 50 20 5.62 1.58 0.89];

% Zone 6
zn(14).thick = [50 3800 9200 6000 20000 61000 150000 160000 110000 150000 230000 100000];
zn(14).rho = [70 100 14000 7700 12000 3300 700 120 20 2.4 1.12 0.48];

% Zone 3S
zn(11).thick = [10 14000 11000 8000 67000 50000 100000 160000 110000 150000 230000 100000];
zn(11).rho = [70 850 400 300 140 80 210 50 20 5.62 1.58 0.89];
